...
% Supress warning of incompatibility of SIunitx and physics with \qty 
\ExplSyntaxOn
...
\newcommand{\Deckblatt}[5][\LaTeX-Satz und Design von Martin Beyer]{
  ...
  % Set the default page style to scrheadings
  ...
  \ohead{\textbf{#5}} % outer header
  \ofoot*{\bfseries\thepage} % outer footer
  % \pagestyle{fancy}
  % \fancyhead[R]{\textbf{#5}}
